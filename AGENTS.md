...
- ALWAYS bump `?v=` to the next integer in the HTML reference of the changed asset (current: `styles.css?v=6`, `settings.css?v=3`, `vault.css?v=1`, `app.js?v=4`, `settings.js?v=3`, `vault.js?v=1`, `chat.js?v=1`).
